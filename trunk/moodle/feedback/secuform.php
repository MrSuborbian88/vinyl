...
$recipient = "MrSuborbian88@gmail.com"; // youremail@domain.com

// bcc emails (separate multiples with commas (,))
$bcc = "finland666@gmail.com, James.mcatamney@gmail.com, James.mcatamney@gmail.com, torquestomp@gmail.com";

// referers.. domains/ips that you will allow forms to
// reside on.
// $referers = array ('http://vinyl.myrpi.org/','www.somedomain.com','121.0.0.111');
...
if ($redirect) {
   ...
   echo "Thank you for your submission your feedback is appreciated!\n";
   echo "<br><br>\n";
// echo "<small>This form is powered by <a href=\"http://www.dtheatre.com/scripts/\">Jack's Formmail.php ".VERSION."!</a></small>\n\n";
   exit;
}
